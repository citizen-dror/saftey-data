...
function getFilter(queryObject, useMatch, addCityLookup) {
    ...
    if (filterSev)
        arrAnd.push(filterSev);
    if (filterInjType)
        arrAnd.push(filterInjType);
    if (filterCity)
        arrAnd.push(filterCity);
    if (filterStreet)
        arrAnd.push(filterStreet);
    if (filterRoadNum)
        arrAnd.push(filterRoadNum);
    if (filterRoadSeg)
        arrAnd.push(filterRoadSeg);
    if (filterAge)
        arrAnd.push(filterAge);
    if (filterSex)
        arrAnd.push(filterSex);
    if (filterPopType)
        arrAnd.push(filterPopType);
    if (filterDayNight)
        arrAnd.push(filterDayNight);
    if (filterMonth)
        arrAnd.push(filterMonth);
    if (filtrtAccidentType)
        arrAnd.push(filtrtAccidentType);
    if (filterVehicle)
        arrAnd.push(filterVehicle);
    if (filterRoadType)
        arrAnd.push(filterRoadType);
    if (filterSpeedLimit)
        arrAnd.push(filterSpeedLimit);
    if (filterRoadWidth)
        arrAnd.push(filterRoadWidth);
    if (filterMultiLane)
        arrAnd.push(filterMultiLane);
    if (filterOneLane)
        arrAnd.push(filterOneLane);
...
//# sourceMappingURL=accidentFilter.js.map